...
<p/>
<p dir="RTL">
Secret and configuration management:اسرار و پیکربندی برنامه را بدون بازسازی تصویر خود و بدون افشای اسرار در تنظیمات پشته خود، مستقر و به روز کنید.
<p/>
<p dir="RTL">
...
<p dir="RTL">
Volume :Volume دایرکتوری است با داده هایی که برای یک کانتینر قابل دسترسی است. Volome با Pod هایی که آن را محصور می کند ، به پایان می رسد.
<p/>
<p dir="RTL">
